...
import serviceData from './../data/service-menu-data';
...
<Layout>
    <div>
      <div className="Hero">
        <div className="HeroGroup">
          <h1>Soluciones tecnologicas <br/> para tu <strong>negocio</strong></h1>
          
          <p>Desarrollo de sistemas a la medida utilizando las mejores practicas del mercado</p>
          <Link to="/page-2/">COMIENZA AHORA</Link>
    ...
    <div className ="Cards">
      <h2>Desarrollado por emprendedores venezolanos</h2>
      <h2>Servicios</h2>
